...
public abstract class Articulo implements Serializable { //es abstract porque se utilizarán sus hijos, el Ordenador y el Componente. Este último tiene una diferencia: el número máximo en stock (Ordenadores, solo uno por tipo)
    ...
    public Articulo(String n, double p, String c, int i){
        nombre = n;
        precio = p;
        caracteristicas = c;
        imagen = i;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if(nombre.equals(art.getNombre()) && caracteristicas.equals(art.getCaracteristicas()) && precio == art.getPrecio() && imagen == art.getImagen()) return true;
        return false;
    }
